...
def ua():
    ...
    xx=f"Mozilla/5.0 (Linux; Android 11; SM-A107M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5825.199 Mobile Safari/537.36"
    return xx
#----------------------------[LOGO]-----------------------------------#
logo = (f"""        
   \033[0;32m   
...
[\033[1;92m\033[1;34m✔\033[1;92m]VERSION        \033[1;91m\033[1;34m: \033[1;35m[\033[1;32mV8\033[1;35m]
\x1b[1;92m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━══━═━═━═""")
#----------------------------[MAIN/DEF]-----------------------------------#
def main():
    user=[]
...
def Subscraption():
	...
	if key1 in r1:
		...
		print(" \033[1;32m Note : Prince Toll Free Hai Dosto   \033[1;37m")
		print ("")
